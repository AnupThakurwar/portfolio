            ...
            <div className="h-full flex items-center flex-col p-5 lg:h-screen lg:flex lg:items-center lg:flex-col">
              <div className="flex-grow flex justify-center flex-col">
                ...
                <p className="">
                  ...
                  <div className="text-5xl md:text-6xl sm:text-4xl lg:text-8xl xl:text-10xl font-bold px-2 text-yellow-400 transition-all ease-in-out duration-300 hover:scale-150 uppercase">
                    {details.firstName}
                  </div>
                  <div className="text-5xl md:text-6xl sm:text-4xl lg:text-8xl xl:text-10xl font-bold px-2 text-yellow-400 transition-all ease-in-out duration-300 hover:scale-110 uppercase">
                    {details.lastName}
                  </div>
                </p>
